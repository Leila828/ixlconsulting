    ...
    const videos: VideoCardProps[] = [
        {
            ...
            youtubeId: "4W2YlxO3sYs?si=ziFh_Thcg6Ekycn_",
            gradient: "bg-gradient-to-br from-[var(--brand-dark-deep)] via-[#0F5092] to-[var(--brand-primary-light)]",
        },
        {
            title: "Oman Youth Ideathon",
            description: "A national-scale ideathon designed to surface, validate, and accelerate local innovation talent",
            thumbnailLabel: "Ideathon",
            youtubeId: "7DDF8AnLwTU?si=VEmxwy6Iy6f90E--",
        ...
        },
        {
            ...
            youtubeId: "X26WDBzMwX0?si=iBeLahMJ6et721CN",
