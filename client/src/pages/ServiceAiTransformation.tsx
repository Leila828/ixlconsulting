...
export default function ServiceAiTransformation() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-[var(--brand-dark-deep)] text-white py-14 md:py-16">
        <div className="container mx-auto grid gap-6 md:grid-cols-2 items-start">
          <Card className="p-6 border border-blue-500/40 bg-[var(--brand-dark)]">
            <div className="flex items-center gap-2 mb-3">
              <LineChart className="h-4 w-4 text-[var(--brand-primary-light)]" />
